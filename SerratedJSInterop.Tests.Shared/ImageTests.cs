...
public partial class TestsContainer
{
    ...
    public class Image_Src_Base64DataUrl : JQTest
    {
    ...
    public class Image_Alt_GetSet : JQTest
    {
        public override void Run()
        {
            var img = new Image();
    ...
    public class Image_Width_Height_GetSet : JQTest
    {
        public override void Run()
        {
            var img = new Image();
    ...
    public class Image_Complete_IsBoolean : JQTest
    {
        public override void Run()
        {
            var img = new Image();
    ...
    public class Image_NaturalDimensions_BeforeLoad : JQTest
    {
        public override void Run()
        {
            var img = new Image();
    ...
    public class Image_NaturalDimensions_AfterDataUrlLoad : JQTest
    {
        public override void Run()
        {
            var img = new Image();
